IF OBJECT_ID('PS_SD040_01') IS NOT NULL
BEGIN
	DROP PROC PS_SD040_01
END
GO
--EXEC PS_SD040_01 '2-1',1
CREATE PROC PS_SD040_01
(
	@SD030Num NVARCHAR(40)
)
AS
BEGIN
	SELECT
	...
	WHERE
		CONVERT(VARCHAR,PS_SD030H.DocEntry) + '-' + CONVERT(VARCHAR,PS_SD030L.LineId) = @SD030Num
