IF OBJECT_ID('PS_PP070_01') IS NOT NULL
BEGIN
	DROP PROC PS_PP070_01
END
GO
--EXEC PS_PP070_01 '1','101'
CREATE PROC PS_PP070_01
(
	@BPLId NVARCHAR(10),
	@OrdGbn NVARCHAR(50)
)
...
BEGIN		
	...
	BEGIN
		...
		WHERE
			...
			AND PS_PP030H.U_OrdGbn IN('101') --휘팅,엔드베어링
