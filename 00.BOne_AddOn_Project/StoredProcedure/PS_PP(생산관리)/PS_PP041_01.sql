IF OBJECT_ID('PS_PP041_01') IS NOT NULL
BEGIN
	DROP PROC PS_PP041_01
END
GO
--EXEC PS_PP041_01 '선택','선택','CP50103'
CREATE PROC PS_PP041_01
(
	@BPLId NVARCHAR(10),
	@OrdGbn NVARCHAR(10), --작업구분
	@CpCode NVARCHAR(30) -- 공정
)
AS
BEGIN
	...
	BEGIN
		...
		WHERE
			...
			AND PS_PP030M.U_ReportYN = 'Y' --일보여부가 Y이면
	END
